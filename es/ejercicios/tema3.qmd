...
::: {.callout-note title="4.1 Función `raiz_cubica(x, tol)`:" collapse="true"}
...
::: {.callout-note title="4.2 Función `biseccion(f, a, b, tol)`:" collapse="true"}
...
::: {.callout-note title="4.2 Función `regula_falsi(f, a, b, tol)`:" collapse="true"}
