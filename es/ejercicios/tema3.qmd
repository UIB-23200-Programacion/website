...
::: {.callout-note title="1.1 Función `es_perfecto(n)`:" collapse="true"}
...
::: {.callout-note title="1.2 Función `siguiente_primo(n)`:" collapse="true"}
...
::: {.callout-note title="1.3. Función `collatz_tstime(n)`:" collapse="true"}
...
::: {.callout-note title="1.4. Función `collatz_max(n)`:" collapse="true"}
...
::: {.callout-note title="1.5. Función `p_fibonacci(n, p)`:" collapse="true"}
...
::: {.callout-note title="1.6. Función `phi_euler(n)`:" collapse="true"}
...
::: {.callout-note title="1.7. Función `tau(n)`:" collapse="true"}
...
::: {.callout-note title="1.8. Función `sigma(n)`:" collapse="true"}
...
::: {.callout-note title="1.9. Función `exponenciacion_rapida(a, n)`:" collapse="true"} 
...
::: {.callout-note title="1.10. Función `exponenciacion_modular(a, n, m)`:" collapse="true"}
...
::: {.callout-note title="2.1 Función `area_elipse(a, b)`:" collapse="true"}
...
::: {.callout-note title="2.2 Función `area_triangulo(a, b, c)`:" collapse="true"}
...
::: {.callout-note title="2.3 Función `area_trapecio(b1, b2, h)`:" collapse="true"}
...
::: {.callout-note title="2.4 Función `es_cuadrilatero_valido(a, b, c, d)`:" collapse="true"}
...
::: {.callout-note title="2.5 Función `area_maxima_cuadrilatero(a, b, c, d)`:" collapse="true"}
...
::: {.callout-note title="2.6 Función `area_poligono_regular(n, l)`:" collapse="true"}
...
::: {.callout-note title="2.7 Función `es_cuadrado(l, r, d, u)`:" collapse="true"}
...
::: {.callout-note title="2.8 Función `make_a_triangle(a, b, c)`:" collapse="true"}
...
::: {.callout-note title="2.9 Función `perimetro_minimo(n)`:" collapse="true"}
...
::: {.callout-note title="2.10 Función `ortoedro(l, m, n)`:" collapse="true"}
...
::: {.callout-note title="3.1 Función `decimal_a_binario(n)`:" collapse="true"}
...
::: {.callout-note title="3.2 Función `segundos_a_dhms(s)`:" collapse="true"}
...
::: {.callout-note title="3.3 Función `dhms_a_segundos(d, h, m, s)`:" collapse="true"}
...
::: {.callout-note title="3.4 Representación de fechas con único entero:" collapse="true"}
...
::: {.callout-note title="3.4.1 Función `fecha_a_entero(año, mes, dia)`:" collapse="true"}
...
::: {.callout-note title="3.4.2 Función `entero_a_fecha(n)`:" collapse="true"}

Convierte un número entero no negativo en formato YYYYMMDD a una fecha dada por año, mes y día en el formato DD/MM/AAAA. 
...
::: {.callout-note title="3.4.3 Función `entero_a_unix(n)`:" collapse="true"}
...
::: {.callout-tip title="Ejemplo"}
```python
print(entero_a_unix(20260907))  # 1788739200
print(entero_a_unix(19000101))  # -2208988800
```
:::

:::

::: {.callout-note title="3.4.4 Función `unix_a_entero(t)`:" collapse="true"}
...
::: {.callout-important title="Algoritmo para 3.4.3 y 3.4.4" collapse="true"}

A continuación el pseudocódigo de implementaciones para las funciones en 3.4.3 y 3.4.4. Se emplea el [algoritmo de Howard Hinnant](https://howardhinnant.github.io/date_algorithms.html?utm_source=chatgpt.com){target="_blank"} expuesto en las funciones *civil-to-days* y *days-to-civil*. Trate de convertir de pseudocódigo a Python de la manera más eficiente posible.
