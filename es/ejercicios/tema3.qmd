...
Esta función se puede emplear en el problema [Draw a Square](https://codeforces.com/problemset/problem/2074/A) de [Codeforces](https://codeforces.com/). La traducción de parte del enunciado es la siguiente:
...
Esta función se puede emplear en el problema [Make a Triangle!](https://codeforces.com/contest/1064/problem/A) de [Codeforces](https://codeforces.com/). La traducción de parte del enunciado es la siguiente:
...
Esta función se puede emplear en el problema [Lazy Security Guard](https://codeforces.com/contest/859/problem/B) de [Codeforces](https://codeforces.com/). La traducción de parte del enunciado es la siguiente:
...
### 2.10 Función `paralelepipedo(l, m, n)`:

Esta función se puede emplear en el problema [Parallelepiped](https://codeforces.com/contest/224/problem/A) de [Codeforces](https://codeforces.com/). La traducción de parte del enunciado es la siguiente:

> Tienes un paralelepípedo rectangular con aristas de longitudes enteras. Conoces las áreas de sus tres caras que tienen un vértice común. Tu tarea es encontrar la suma de las longitudes de las 12 aristas de este paralelepípedo.
